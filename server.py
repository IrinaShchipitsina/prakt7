...
print('''
pwd - показать название текущей директории;
ls - показать содержимое текущей директории;
cd <path> - переместиться в директорию <path>;
mkdir <dirname> - создать директорию <dirname> (рекурсивно);
rmtree <dirname> - удалить директорию <dirname> (рекурсивно);
touch <filename> - создать пустой файл;
remove <filename> - удалить файл;
cat <filename> - отправить содержимое файла;
get_file <filename> - получить файл от клиента;
send_file <filename> - отправить файл в (текущую) директорию клиента.
''')
